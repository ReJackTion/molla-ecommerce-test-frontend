...
function ElectronicsCollection(props): JSX.Element {
      ...
      <div className="col-xl-3 col-xxl-4">
        <div className="cat-banner row no-gutters">
          <div
            ...
            style={{
              backgroundImage: `url(images/home/banners/banner-bg-1.jpg)`,
            }}
          >
            <div className="banner-list-content">
              <h2>
                <ALink href="/shop/sidebar/list">Electronics</ALink>
              </h2>

              <ul>
                <li>
                  <ALink href="/shop/sidebar/list">Cell Phones</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Computers</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">TV & Video</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Smart Home</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Audio</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Home Audio & Theater</ALink>
                </li>
