...
function ShopNoSidebar(): JSX.Element {
  ...
  useEffect(() => {
    getProducts({
      variables: {
        ...
        minPrice: parseInt(String(query.minPrice)),
        maxPrice: parseInt(String(query.maxPrice)),
  ...
  function onSortByChange(e): void {
