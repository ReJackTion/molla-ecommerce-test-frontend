...
function FurnitureCollection(props): JSX.Element {
      ...
      <div className="col-xl-3 col-xxl-4">
        <div className="cat-banner row no-gutters">
          <div
            ...
            style={{
              backgroundImage: `url(images/home/banners/banner-bg-2.jpg)`,
            }}
          >
            <div className="banner-list-content">
              <h2>
                <ALink href="/shop/sidebar/list">Furniture</ALink>
              </h2>

              <ul>
                <li>
                  <ALink href="/shop/sidebar/list">Bedroom</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Office</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Living Room</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Kitchen & Dining</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Decoration</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Outdoor</ALink>
                </li>
