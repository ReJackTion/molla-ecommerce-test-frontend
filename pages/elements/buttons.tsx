  ...
  return (
    <div className="main">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                ...
                <ALink href="#" className="btn btn-primary btn-rounded">
                  Button text
                </ALink>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                <span>Rounded Corners Style</span>
                <ALink href="#" className="btn btn-outline-primary btn-rounded">
                  Button text
                </ALink>
              </div>
            </div>
            ...
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                <span>Round Style</span>
                <ALink href="#" className="btn btn-outline-primary btn-round">
                  Button text
                </ALink>
              </div>
            </div>
            ...
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                <span>Rounded Corners Style</span>
                <ALink href="#" className="btn btn-outline-dark btn-rounded">
                  Button text
                </ALink>
              </div>
            </div>
            ...
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                <span>Square Style</span>
                <ALink href="#" className="btn btn-outline-dark">
                  Button text
                </ALink>
              </div>
            </div>
            ...
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                <span>Round Style</span>
                <ALink href="#" className="btn btn-outline-dark btn-round">
                  Button text
                </ALink>
              </div>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-6 col-lg-4 col-xl-2">
              <div className="btn-wrap">
                <span>Square Style</span>
                <ALink href="#" className="btn btn-primary btn-shadow">
                  Button text
                </ALink>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-12">
              <ALink href="#" className="btn btn-link">
                Button Text
              </ALink>
              <ALink href="#" className="btn btn-link">
                <span>Button Text</span>
              ...
              <ALink href="#" className="btn btn-link btn-link-dark">
                Button Text
              </ALink>
              <ALink href="#" className="btn btn-link btn-link-dark">
                <span>Button Text</span>
      ...
      <div
        ...
        style={{ backgroundImage: `url(images/backgrounds/bg-large.jpg)` }}
      >
        <div className="container">
          <div className="row">
            <div className="col-6 col-lg-4 col-xl-2">
