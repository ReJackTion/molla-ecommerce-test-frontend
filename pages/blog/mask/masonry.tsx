...
function BlogMaskMasonry(): JSX.Element {
  ...
  function isoFilter(e, cat): void {
    ...
    iso.arrange({
      filter: function (index, itemElem): any {
        if (cat == '') return true
                ...
                <div className="row" ref={ref}>
                  {posts.map((post, index) => (
                    <div
                      ...
                      key={index}
                    >
                      <PostThree post={post} adClass="text-center" />
                    </div>
                  ))}
                </div>
              )}
