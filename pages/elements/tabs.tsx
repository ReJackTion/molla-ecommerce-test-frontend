...
function ElementTabs(): JSX.Element {
  return (
    <div className="main">
                ...
                <div className="tab-pane tab-content tab-content-border">
                  ...
                  <TabPanel>
                    <p>
                      ...
                      repellat distinctio atque alias excepturi aspernatur nisi
                      accusamus sed molestias ipsa numquam eius, iusto, aliquid,
                      quis aut.
                    </p>
                  </TabPanel>
                  <TabPanel>
                    <p>
                      ...
                      Dolorum, earum. Consectetur pariatur repellat distinctio
                      atque alias excepturi aspernatur nisi accusamus sed
                  ...
                  <div className="tab-pane tab-content tab-content-border">
                    <TabPanel>
                      <p>
                        ...
                        eget felis facilisis fermentum int dolore earum rerum
                        tempora aspernatur numquam velit.&nbsp;
                      </p>
                      &nbsp;
                    </TabPanel>
                    <TabPanel>
