    ...
    <div className="main">
      ...
      <div className="page-content">
        <div className="container">
          ...
          <OwlCarousel adClass="owl-testimonials cols-1" options={mainSlider5}>
          ...
          >
            <blockquote className="testimonial testimonial-icon text-center">
              <p>
                “ Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi
                neque, aliquet vel, dapibus id, mattis vel, nisi tortor eu nibh.
                Nullam mollis. ”
              </p>
              <cite>
                Jenson Gregory
            ...
            <blockquote className="testimonial testimonial-icon text-center">
              <p>
                “ Molestias animi illo natus ut quod neque ad accusamus
                praesentium fuga! Dolores odio alias sapiente odit delectus
                quasi, explicabo a, modi voluptatibus. Perferendis, voluptate,
                distinctio earum veritatis animi. ”
              </p>
          ...
          >
            <blockquote className="testimonial testimonial-icon text-center">
              <p>
                “ Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                Phasellus quet vel, dapibus id, mattis vel, nisi tortor eu nibh.
                Nullam mollis. ”
              </p>
              <cite>
                Jenson Gregory
        ...
        <div
          ...
          style={{ backgroundImage: 'url(images/backgrounds/bg-1.jpg)' }}
        >
          <div className="container">
