...
function ProductFour(props): JSX.Element {
  ...
  function onCartClick(e): void {
    e.preventDefault()
    props.addToCart(product)
  }

  function onWishlistClick(e): void {
    e.preventDefault()
  ...
  function onCompareClick(e): void {
    e.preventDefault()
  ...
  function mouseLeaveHandler(): void {
    ref.current
      .querySelector('.product-footer')
      .setAttribute('style', 'visibility: hidden; transform: translateY(100%);')
    ref.current
      .querySelector('.product-body')
