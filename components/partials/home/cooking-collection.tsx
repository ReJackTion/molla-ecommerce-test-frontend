...
function CookingCollection(props): JSX.Element {
      ...
      <div className="col-xl-3 col-xxl-4">
        <div className="cat-banner row no-gutters">
          <div
            ...
            style={{
              backgroundImage: `url(images/home/banners/banner-bg-4.jpg)`,
            }}
          >
            <div className="banner-list-content">
              <h2>
                <ALink href="/shop/sidebar/list">Cooking</ALink>
              </h2>

              <ul>
                <li>
                  <ALink href="/shop/sidebar/list">Cookware</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Dinnerware</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Cups</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Microwaves</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Toasters</ALink>
                </li>
                <li>
                  <ALink href="/shop/sidebar/list">Coffee Makers</ALink>
                </li>
